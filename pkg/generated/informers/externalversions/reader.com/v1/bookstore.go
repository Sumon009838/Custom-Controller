...
import (
	...
	readercomv1 "github.com/Sumon009838/CRD/pkg/apis/reader.com/v1"
	versioned "github.com/Sumon009838/CRD/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/Sumon009838/CRD/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/Sumon009838/CRD/pkg/generated/listers/reader.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BookStoreV1().BookStores(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BookStoreV1().BookStores(namespace).Watch(context.TODO(), options)
			},
		},
		&readercomv1.BookStore{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *bookStoreInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&readercomv1.BookStore{}, f.defaultInformer)
}

func (f *bookStoreInformer) Lister() v1.BookStoreLister {
	return v1.NewBookStoreLister(f.Informer().GetIndexer())
}
